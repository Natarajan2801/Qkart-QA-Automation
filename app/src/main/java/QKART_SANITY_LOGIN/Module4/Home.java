...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            wait.until(ExpectedConditions.or(ExpectedConditions.textToBePresentInElementLocated(By.xpath("//h4[text()=' No products found ']"),"No products found"),
            ExpectedConditions.presenceOfElementLocated(By.xpath("//div[contains(@class,'css-sycj1h')]"))));
            //Thread.sleep(3000);
            List<WebElement> SearchedItems= driver.findElements(By.xpath("//div[contains(@class,'css-sycj1h')]"));
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            //div[@class='MuiBox-root css-1gjj37g']//div[text()

            WebElement cartParent = driver.findElement(By.className("cart"));
            List<WebElement> cartContents = cartParent.findElements(By.className("css-1gjj37g"));

            ArrayList<String> actualCartContents = new ArrayList<String>() {
            };
            for (WebElement cartItem : cartContents) {
                actualCartContents.add(cartItem.findElement(By.xpath("//div[contains(@class,'css-1gjj37g')]/div")).getText().split("\n")[0]);
              //  System.out.println("----------checking  "+cartItem.findElement(By.xpath("//div[contains(@class,'css-1gjj37g')]/div")).getText().split("\n")[0]);
            }
