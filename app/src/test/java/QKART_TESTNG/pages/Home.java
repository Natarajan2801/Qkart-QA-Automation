...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath(String
                    .format("//div[@class='MuiCardContent-root css-1qw96cp'][1]/p[contains(text(),'%s')] | //h4[text()=' No products found ']", product))));
            Thread.sleep(3000);
            return true;
        } catch (Exception e) {
            ...
            for (WebElement cell : gridContent) {
                if (productName.contains(cell.findElement(By.className("css-yg30e6")).getText())) {
                    ...
                    wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
                            String.format("//*[@class='MuiCardContent-root css-1qw96cp']/p[text()='%s']", productName))));
                            cell.findElement(By.tagName("button")).click();
                            //*[@class='MuiBox-root css-1gjj37g']/div[1][text()='%s']
                            //*[@class='MuiCardContent-root css-1qw96cp']/p[text()='Tan Leatherette Weekender Duffle']
                    return true;
                }
            }
    ...
    public Boolean clickCheckout() {
        ...
        try {
           ...
           // Thread.sleep(2000);
            WebDriverWait wait = new WebDriverWait(driver, 30);
            wait.until(ExpectedConditions.presenceOfElementLocated(By.className("checkout-btn")));
