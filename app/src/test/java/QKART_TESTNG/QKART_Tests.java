...
public class QKART_Tests {
    ...
    public void TestCase02(String username, String Password) throws InterruptedException {
        ...
        assertTrue(status, "Unable to login with registered user");
        // if (!status) {
        ...
        assertFalse(status,"Test Case 2: Unable to Verify user Registration");
    ...
    public void TestCase04() throws InterruptedException {
        ...
        logStatus("TestCase 4", "End Test Case: Validated Size Chart Details",
                status ? "PASS" : "FAIL");
        assertTrue(status," Unable to Validated Size Chart Detail");
        // return status;
    }
    ...
    public void TestCase05(String YONEX, String Tan, String Address) throws InterruptedException {
        ...
        status = homePage.searchForProduct("YONEX");
       status= homePage.addProductToCart(YONEX);
        status = homePage.searchForProduct("Tan");
        status=homePage.addProductToCart(Tan);
        ...
        assertTrue(status, "Test Case 5: Happy Flow Test Completed ");
    ...
    public void TestCase06(String Xtend, String Yarine) throws InterruptedException {
        ...
        homePage.navigateToHome();
        homePage.PerformLogout();
        assertTrue(status, "Test Case 6: Failed ");
    ...
    @Parameters({"Stylecon", "Qty"})
    public void TestCase07(String Stylecon, int Qty) throws InterruptedException {
        Boolean status;
        logStatus("Start TestCase",
        ...
        status = registration.registerUser("testUser", "abc@123", true);
        Thread.sleep(3000);
        assertTrue(status, "Test Case 7: User Perform Registration Failed ");
    ...
    public void TestCase08() throws InterruptedException {
        ...
        assertTrue(status, "Unable to Verify that product added to cart is available when a new tab is opened");
        // return status;
    }
    ...
    public void TestCase09() throws InterruptedException {
        ...
        logStatus("End TestCase",
                "Test Case 9: Verify that the Privacy Policy, About Us are displayed correctly ",
                "PASS");
        assertTrue(status,"Unable to Verify that the Privacy Policy, About Us are displayed correctly");
    ...
    public void TestCase10() throws InterruptedException {
      ...
      //  assertTrue(status,"Unable to Verify that contact us option is working correctly")
  ...
  //  groups={"Regression_Test"},
    ...
    public void TestCase11() throws InterruptedException {
        ...
        logStatus("End TestCase",
                "Test Case 11:  Ensure that the links on the QKART advertisement are clickable",
                status ? "PASS" : "FAIL");
        assertTrue(status,"Unable to Ensure that the links on the QKART advertisement are clickable");
        // return status;
    }
